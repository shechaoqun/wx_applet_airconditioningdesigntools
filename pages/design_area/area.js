...
var air_c_area_dict_dao = require("../../dao/air_c_area_dict_dao.js");
var room_type = air_c_area_dict_dao.getRoomType();
...
Page({
    ...
    bindPickerChange_1_1: function (e) {
        ...
        machin_type = air_c_area_dict_dao.getMachinType(temp);
    ...
    bindPickerChange_1_2: function (e) {
        ...
        horses_number = air_c_area_dict_dao.getHorsesNumber(area_array[this.data.itemid - 1].room_type, temp);
        this.btn_refresh_view();
    ...
    btn_build: function (e) {
      area_array = air_c_area_dict_dao.getDataList(area_array);
      this.btn_refresh_view();
        wx.navigateTo({
            url: '../configuration_center/center?area_array='+JSON.stringify(area_array)
        })
    },
